...
export default function ServiceBooking() {
  const [svc, setSvc] = useState<ServiceType>('BaoDuong');
  ...
  return (
    <div style={{ background: 'var(--color-zinc-50)', minHeight: '100vh' }}>
      {/* Hero */}
      <div className="py-10 px-6" style={{ background: 'linear-gradient(135deg, var(--color-zinc-950) 0%, #3b0606 60%, var(--color-zinc-950) 100%)' }}>
      ...
      <form onSubmit={handleSubmit} className="max-w-3xl mx-auto px-4 sm:px-6 py-8 flex flex-col gap-6">
        {/* Step 1: Service type */}
